                ...
                <div class="main-navigation">
                    ...
                    <nav class="site-navigation">
                            <ul>
                                ...
                                <li><a href="#posts">Reservations</a></li>
        ...
        <div class="welcome-text">
            <div class="container text-center white-text">
                <div class="col-xs-8 col-xs-offset-2">
                    <h1>
                        Hello, Welcome to Carenta Carsa Rentals</h1>
                    <h4>
                        &nbsp; Carenta Car Rental is an online Car rental platform that&nbsp; you can rent any type of cars&nbsp; Thank you for visiting our website.</h4>
                    <h4>
                        <asp:Image ID="Image1" runat="server" Height="23px" ImageUrl="~/64113.png" Width="30px" />
                        <asp:TextBox ID="TextBox1" runat="server" Height="29px" Width="185px" PlaceHolder="Enter Location" cssclass="txtbox"  BackColor="Transparent" BorderColor="Transparent" >Istanbul</asp:TextBox>
                        <asp:Image ID="Image2" runat="server" Height="28px" ImageUrl="~/calendar-512.png" Width="28px" />
                        <asp:TextBox ID="TextBox2" runat="server" Height="29px" Width="166px" PlaceHolder="Date" cssclass="txtbox"  BackColor="Transparent" BorderColor="Transparent" TextMode="Date" ></asp:TextBox>
                        <asp:Image ID="Image3" runat="server" Height="19px" ImageUrl="~/143423-200.png" Width="29px" />
                        <asp:TextBox ID="TextBox3" runat="server" Height="29px" Width="166px" PlaceHolder="Date" cssclass="txtbox"  BackColor="Transparent" BorderColor="Transparent" TextMode="Date" ></asp:TextBox>
                    <a href="#" class="btn btn-primary">Search</a></h4>
